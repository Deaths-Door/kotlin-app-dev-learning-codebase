package com.example.multifunctioncalculator.algebra
...
import com.example.multifunctioncalculator.convertor.ConvertorPage
import com.example.multifunctioncalculator.convertor.GridRVAdapter

class AlgebraOptions : AppCompatActivity() {
    private lateinit var courseGRV: GridView
    private lateinit var gridviewList: List<GridViewModal>

    //list of algebra solvers options
    private val options = arrayListOf("Length","Time","Mass","Area","Volume","Speed"
        ,"Temperature","Numeral System","Pressure")
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_algebra_options)
        ...
        //adapter
        val courseAdapter = GridRVAdapter(gridviewList = gridviewList, this@AlgebraOptions)
